export default function ContactoForm() {
  return (
    <section className="w-full bg-[#172555] py-16 px-6">
      <div className="max-w-[1272px] mx-auto flex gap-16 items-start">

        {/* Columna izquierda — info de contacto */}
        <div className="flex flex-col gap-10 flex-shrink-0 w-[200px] pt-12">
         {/* WhatsApp COMENTADO
          <div>
        ...
        <div className="flex-1 bg-[#0D1640] rounded-[16px] p-8">
