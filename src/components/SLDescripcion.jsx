export default function SLDescripcion() {
  return (
    <section className="w-full flex items-center justify-center px-6 h-[417px] bg-gradient-to-b from-[#030C40] to-[#172555] border-t border-b border-white/60">
      <div className="max-w-3xl w-full flex flex-col items-center text-center gap-6">
        <h2 className="text-white font-bold text-[30px] leading-[35px]">
          Todo el control de tu red lumínica, en una sola plataforma
        </h2>
